...
$manipulas = new AlunoManipulaDados();
$dados = $manipulas->getMeusCertificados($_SESSION["id"]);
...
foreach ($dados as $dado) {
    $tempStatus = $dado["status"];
?>
    <tr class="item">
        <th class="start"><?= $dado["id"] ?></th>
        ...
        <td>
            <a class="btn d-inline" href="../<?= $dado["url"] ?>" target="_blank" rel="noopener noreferrer">
